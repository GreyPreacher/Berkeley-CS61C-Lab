...
mapLoop:
    ...
    slli t3, t0, 2      # 4 bytes offset
    add t4, t3, t1      # offset the array address by the count
    lw a0, 0(t4)        # load the value at that address [t4] into [a0]
    ...
    jalr ra, s1, 0      # call the function at [s1]
    ...
    add a1, x0, s1      # load the function into [a1]
    jal  map            # recurse
done:
    lw s0, 8(sp)
    lw s1, 4(sp)
